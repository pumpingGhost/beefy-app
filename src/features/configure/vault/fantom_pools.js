export const fantomPools = [
  ...
  {
    id: 'mini-mvdollar-usdc',
    name: 'MvDOLLAR-USDC LP',
    token: 'MvDOLLAR-USDC LP',
    tokenDescription: 'SpookySwap (MiniVerse)',
    tokenAddress: '0x35bED1E2f3033395a05CD0b1b5900209ECe42774',
    tokenDecimals: 18,
    tokenDescriptionUrl: '#',
    earnedToken: 'mooMiniMvDOLLAR-USDC',
    earnedTokenAddress: '0x44AA75F5c68Ed51B97C117C86A0274b5514860a9',
    earnContractAddress: '0x44AA75F5c68Ed51B97C117C86A0274b5514860a9',
    pricePerFullShare: 1,
    tvl: 0,
    oracle: 'lps',
    oracleId: 'mini-mvdollar-usdc',
    oraclePrice: 0,
    depositsPaused: false,
    status: 'active',
    platform: 'MiniVerse',
    ...
    buyTokenUrl:
      'https://spookyswap.finance/swap?inputCurrency=0x04068DA6C83AFCFA0e13ba15A6696662335D5B75&outputCurrency=0x57976c467608983513c9355238dc6de1B1aBbcCA',
    createdAt: 1646906462,
  },
  {
    id: 'mini-mshare-usdc',
    name: 'MSHARE-USDC LP',
    ...
    tokenDecimals: 18,
    tokenDescriptionUrl: '#',
    earnedToken: 'mooMiniMSHARE-USDC',
    earnedTokenAddress: '0x2F9C2B9D6ca06a20DC36011BaBec73Ad2fe18B25',
    earnContractAddress: '0x2F9C2B9D6ca06a20DC36011BaBec73Ad2fe18B25',
    pricePerFullShare: 1,
    tvl: 0,
    oracle: 'lps',
    oracleId: 'mini-mshare-usdc',
    oraclePrice: 0,
    depositsPaused: false,
    status: 'active',
    platform: 'MiniVerse',
    ...
    buyTokenUrl:
      'https://spookyswap.finance/swap?inputCurrency=0x04068DA6C83AFCFA0e13ba15A6696662335D5B75&outputCurrency=0xb011EC534d9175cD7a69aFBfc1bcc9990862c462',
    createdAt: 1646906462,
  },
  {
    id: 'mini-mvdollar-mshare',
    name: 'MvDOLLAR-MSHARE LP',
    token: 'MvDOLLAR-MSHARE LP',
    tokenDescription: 'SpookySwap (MiniVerse)',
    tokenAddress: '0x85E8DcBc11eF5C5F98277B20A041C8ab90E0e2f7',
    tokenDecimals: 18,
    tokenDescriptionUrl: '#',
    earnedToken: 'mooMiniMvDOLLAR-MSHARE',
    earnedTokenAddress: '0x35ADD709B08521944936C73B1eC65ed15AE53d5b',
    earnContractAddress: '0x35ADD709B08521944936C73B1eC65ed15AE53d5b',
    pricePerFullShare: 1,
    tvl: 0,
    oracle: 'lps',
    oracleId: 'mini-mvdollar-mshare',
    oraclePrice: 0,
    depositsPaused: false,
    status: 'active',
    platform: 'MiniVerse',
    assets: ['MvDOLLAR', 'MSHARE'],
    risks: [
      'COMPLEXITY_LOW',
      'BATTLE_TESTED',
      'IL_HIGH',
    ...
    withdrawalFee: '0%',
    addLiquidityUrl:
      'https://spookyswap.finance/add/0x57976c467608983513c9355238dc6de1B1aBbcCA/0xb011EC534d9175cD7a69aFBfc1bcc9990862c462',
    buyTokenUrl:
      'https://spookyswap.finance/swap?inputCurrency=0x57976c467608983513c9355238dc6de1B1aBbcCA&outputCurrency=0xb011EC534d9175cD7a69aFBfc1bcc9990862c462',
    createdAt: 1646906462,
  },
  {
    id: 'spirit-ftm-beftm',
